...
public class Controller implements ValueChangeHandler<String> {
	...
	private void initializePresenter() {
		...
		OutreachImagePanel.setStartupId(Window.Location.getParameter(EsaSkyWebConstants.URL_PARAM_JWST_IMAGE), Boolean.parseBoolean(Window.Location.getParameter(EsaSkyWebConstants.URL_PARAM_HIDE_FOOTPRINTS)));
		OutreachImagePanel.setStartupId(Window.Location.getParameter(EsaSkyWebConstants.URL_PARAM_EUCLID_IMAGE), Boolean.parseBoolean(Window.Location.getParameter(EsaSkyWebConstants.URL_PARAM_HIDE_FOOTPRINTS)));
