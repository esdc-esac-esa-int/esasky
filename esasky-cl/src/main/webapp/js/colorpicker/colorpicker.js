			...
			init: function (opt) {
				...
				return this.each(function () {
					if (!$(this).data('colorpickerId')) {
						...
						var id = !$(this).attr('colorpickerId') ? 'colorpicker_' + parseInt(Math.random() * 1000) : $(this).attr('colorpickerId');
...
function createColorPicker(colorPickerId, colorPickerContainerId, defaultColor, onChangeFn) {
