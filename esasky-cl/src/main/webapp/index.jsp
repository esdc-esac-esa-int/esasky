		 ...
		 if (line.startsWith("<!--#METATAGS#")) {
			    ...
			    try {
				    ...
				    */
					...
					final String esaSkyUrl = "https://sky.esa.int/" + ((request.getQueryString() != null) ? "?"+ request.getQueryString() : "");
					String skyImageUrl = (params.length > 3) ? params[3] : "https://sky.esa.int/images/fbESASky.png";
					...
					if ((targetParam != null)
					    ...
					    final String skyImageBaseUrl = (params.length > 4) ? params[4] : "https://sky.esa.int/esasky-tap/skyimage";
