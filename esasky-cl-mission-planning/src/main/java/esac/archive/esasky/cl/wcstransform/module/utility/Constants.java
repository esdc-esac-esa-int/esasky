...
public class Constants {
    ...
    public enum Instrument {
        NIRSPEC(PlanningMission.JWST, "NIRSPEC"), NIRCAM(PlanningMission.JWST, "NIRCAM"), NIRISS(
                PlanningMission.JWST, "NIRISS"), MIRI(PlanningMission.JWST, "MIRI"), FGS(
                        PlanningMission.JWST, "FGS");
